...
function Main() {
  return (
    <Switch>
      ...
      <Route path="/post/安装与过程">
        <Article1 />
      </Route>
      <Route path="/post/所学的技术">
        <Article2 />
      </Route>
    </Switch>
  );
...
function ArticleList() {
  return (
    <div className="content">
      <div className="content-header"><Link to={`/post/安装与过程`}><h1>安装与过程</h1></Link><span>2019-10-22</span></div>
      ...
      <div className="content-header"><Link to={`/post/所学的技术`}><h1>所学的技术</h1></Link><span>2019-10-22</span>  </div>
      <div className="content-article">
